            ...
            if (h)
                        ...
                        ->m < 2 * n)
                {
                    ...
                    for (int i = a
                                     ->m -
                                 1;
                         i >= (r + 1); i--) // corrimiento para insertar
                    ...
                    if (a
                            ->e[r]
                            .kyy > x) // se ubica a el nuevo elemento
                ...
                { //no hay lugar y se debe pedir una nueva página
                    b = new (page);
                    if (r <= n)
